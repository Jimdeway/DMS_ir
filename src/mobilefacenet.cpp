...
Recognize::Recognize(const std::string &model_path) {
	...
	Recognet.opt.num_threads = 4;
	Recognet.opt.use_winograd_convolution = true;
    Recognet.opt.use_sgemm_convolution = true;
    Recognet.opt.use_fp16_packed = true;
    Recognet.opt.use_fp16_storage = true;
    Recognet.opt.use_fp16_arithmetic = true;
    Recognet.opt.use_packing_layout = true;
    Recognet.opt.use_shader_pack8 = true;
    Recognet.opt.use_image_storage = true;
